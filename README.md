...
3. После первого успешного деплоя сайт будет доступен по адресу:
   `https://<ваш-username>.github.io/<название-репозитория>/`

### Защита веток

Для настройки защиты веток `master` и `dev` от прямых коммитов см. [.github/BRANCH_PROTECTION.md](.github/BRANCH_PROTECTION.md)
